...
generate: ${GEN_DIR}/api.pb.go ${GEN_DIR}/api.pb.gw.go \
${GEN_DIR}/health.pb.go ${GEN_DIR}/health.pb.gw.go \
${GEN_DIR}/admin.pb.go ${GEN_DIR}/admin.pb.gw.go \
${GEN_DIR}/auth.pb.go ${GEN_DIR}/auth.pb.gw.go \
${PROTO_DIR}/api_openapi.yaml \
${PROTO_DIR}/admin_openapi.yaml \
${PROTO_DIR}/auth_openapi.yaml
